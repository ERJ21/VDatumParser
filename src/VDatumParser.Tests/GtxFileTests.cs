...
namespace VDatumParser.Tests
{
    ...
    {
        private static GtxFile gtxFileTestObject = new GtxFile("fakePath", 29.650, 270.000, 0.001, 0.001, 6, 7, Array.AsReadOnly<float>(new float[]{
        ...
        private static GtxFile gtxFileTestObjectALFL = new GtxFile("fakePath", 30.171, 272.095, 0.001, 0.001, 5, 4, Array.AsReadOnly<float>(new float[]{
        ...
        private static GtxFile gtxFileTestObjectLAmobile = new GtxFile("fakePath", 30.219, 271.939, 0.001, 0.001, 7, 4, Array.AsReadOnly<float>(new float[]{
